...
// ^FO550,50^A0R,90,90^FDName: ушкушоак^FS
// ^FO400,50^A0R,90,90^FDOrder: 3839^FS
// ^FO350,50^A0R,40,40^FD_______________________^FS
// ^FO150,50^A0R,70,70^FDBox 2 from 3^FS
// ^XZ
//     
// ^XA
...
^FO350,50^A0R,40,40^FD_______________________^FS
^FO150,50^A0R,70,70^FDBox ${current_box} of ${total_boxes}^FS
^XZ
            `;
        } 
...
^FO550,50^A0R,90,90^FDName: ${customer_name}^FS
^FO350,50^A0R,40,40^FD_______________________^FS
^FO150,50^A0R,70,70^FDBox ${i} of ${total_boxes}^FS
^XZ
                `;
            }
        } else {
